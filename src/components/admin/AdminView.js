        ...
        <Row className="mx-auto w-100 text-center">
            <Col md={6} className="mx-auto mb-3">
                <ButtonGroup aria-label="Admin View Options" size="lg" className="shadow">
                    ...
                    disabled={adminView === 'products'}>Products</Button>
                    <Button variant="primary" 
                    onClick={() => setAdminView('users')}
                    disabled={adminView === 'users'}>Users</Button>
                    <Button variant="primary" onClick={() => setAdminView('orders')}
                    disabled={adminView === 'orders'}>Orders</Button>
                </ButtonGroup>
            </Col>
        </Row>
        <Row>
