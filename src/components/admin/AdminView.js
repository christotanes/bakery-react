...
import adminIcon from "../../images/admin_profile.png"

function AdminView({ products, getAllProducts }) {
    const [ adminView, setAdminView ] = useState('products');
    return (
        <>
        <h1 className="text-center font-weight-bold py-3"><span><Image src={adminIcon} width={100} height={100} className="userImg me-3 rounded-circle shadow border border-primary"/></span>Admin Dashboard</h1>
